  ...
  return (
    <div className="shadow-xl xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div
        ...
        <h4 className={styles.sectionHeadText}>Convert the legacy code into modern code in ease</h4>
        <form
          ref={formRef}
...
//           <button
//             type="submit"
//             className="bg-black py-3 px-8 outline-none w-fit font-bold shadow-md shadow-primary rounded-xl text-white-100">
